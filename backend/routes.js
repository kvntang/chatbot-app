...
//we should have 3 different routes
    ...
    const router = express.Router();
      ...
      const mergeSystemMessage = {
        role: 'system',
        content: 'You are recieving two text messages. Find connections and common points between the two and generate a semantically merged message.' // Customize the behavior
        };
